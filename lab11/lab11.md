...
Запускается командой `go run .` в директории `/src`, алгоритм работает асинхронно, взаимодсействие потоков построено на каналах.
В примере реализуется демонстрация работы ситуации с картинки выше с последющим изменением стоимости 0-1 с 1 до 6 и перерасчетом.

На нижнем изображении можно найти конечные таблички с матрицами расстояний, а в верхнем изображении логи работы.

<img src="images/img.png" width=1213  alt=""/>
<img src="images/img_1.png" width=820 alt=""/>
...
#### Демонстрация работы
Запускать в папках src2/server и src2/client через `go run .`

<img src="images/img_2.png" width=1021 alt=""/>
<img src="images/img_3.png" width=1090 alt=""/>

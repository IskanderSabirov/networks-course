...
общее время $t = \dfrac{5 * 1024 * 8 Кбит}{200 Кбит\сек} = 204,8$, но можно учесть, что данные будут проходить еще по двум
...
Возьмем у этого дела производную и получим $-\dfrac{80 * X}{S^2 * R} + 2 = 0$. Отсюда $S =\sqrt{\dfrac{40 \cdot X}{R}}$

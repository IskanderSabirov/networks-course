...
Запуск
``` go run main.go handle.go -t <task> -p <port> ```

<img src="images/TaskA_1.png" width=2514 alt=""/>

<img src="images/TaskA_2.png" width=1511 alt=""/>
...
<img src="images/TaskB_1.png" width=1275 alt=""/>
...
Запуск
``` go run main.go -h <host> -p <port> -f <file> ```



<img src="images/TaskC_1.png" width=2387 alt=""/>

<img src="images/TaskC_2.png" width=1414 alt=""/>
...
Запуск
``` go run main.go handle.go -t <task> -p <port> -l <limit> ```


<img src="images/TaskD_1.png" width=1445 alt=""/>
...
#### Решение
Время формирования одного пакета составляет: $\dfrac{56 * 8}{128000} = 3.5ms$.
Время передачи одного пакеты равно: $\dfrac{56 * 8}{1000000} = 0.448ms$.
Тогда общая задержка составит $3.5 + 0.448 + 5 = 8.948ms$.
...
#### Решение
Распишем формулу Литтла для $N = 10 + 1 = 11$, $d = 10ms + \dfrac{1}{100} = 20 ms$
(второй элемент суммы - время задержки передачи ). Тогда $a = \dfrac{11}{20ms} = 550$ пакетов.

...
$\max\left(\dfrac{10 * 15 * 10^9}{30 * 10^6}, \drfac{15*10^9}{2*10^6}\right)$ = $\max(5 * 10^3, 7,5 * 10^3) = 7,5 * 10^3 $ .
Для одноранговой $\max\left(\dfrac{15*10^9}{30*10^6}, \dfrac{15*10^9}{2*10^6}, \dfrac{10 * 15 * 10^9}{30 * 10^6 + 10 * 300 * 10^3}\right)$ =
$\max(0,5 * 10^3, 7,5 * 10^3, 4,5 * 10^3) = 7,5 * 10^3 $ .

2. $N = 100$ Время для клиент-сервера будет по формулу равняться
$ \max\left(\dfrac{100 * 15 * 10^9}{30 * 10^6}, \drfac{15*10^9}{2*10^6}\right)$ = $\max(50 * 10^3, 7,5 * 10^3) = 50 * 10^3 $ .
Для одноранговой $\max\left(\dfrac{15*10^9}{30*10^6}, \dfrac{15*10^9}{2*10^6}, \dfrac{100 * 15 * 10^9}{30 * 10^6 + 100 * 700 * 10^3}\right)$ =
$\max(0,5 * 10^3, 7,5 * 10^3, 15 * 10^3) = 15 * 10^3 $ .

3. $N = 1000$ Время для клиент-сервера будет по формулу равняться
$\max\left(\dfrac{1000 * 15 * 10^9}{30 * 10^6}, \drfac{15*10^9}{2*10^6}\right)$ = $\max(500 * 10^3, 7,5 * 10^3) = 500 * 10^3 $ .
Для одноранговой $\max(\dfrac{15*10^9}{30*10^6}, \dfrac{15*10^9}{2*10^6}, \dfrac{1000 * 15 * 10^9}{30 * 10^6 + 10 * 2 * 10^6})$ =
$\max(0.5 * 10^3, 7,5 * 10^3, 7,5 * 10^3) = 7,5 * 10 ^3 $ .

...
Рассчитаем $\dfrac{(3 + 2 * 11) * 200}{150} + \dfrac{11 * 100 * 10^3}{150} = 33,3 + 7333 = 7366$ c
...
Рассчитаем $\dfrac{5 * 11 * 200}{150} + \dfrac{11 * 100 * 10^3}{150} = 73,3 + 7333 = 7406$ c

аким образом разница в случаях постоянного и непостоянного соединения составляет всего 60 секунд, что в рамках общего времени передачи является незначительной.
